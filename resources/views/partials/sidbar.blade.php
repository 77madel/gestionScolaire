<div class="sidebar-inner slimscroll">
    <div id="sidebar-menu" class="sidebar-menu">
        <ul>
            ...
            <li class="menu">
                <a href="/"><i class="feather-home"></i>  <span>Acceuil</span> <span
                        class="menu"></span></a>
            </li>

            <li class="submenu active">
                <a href="#" :active="request()->routeIs('name')"><i class="feather-grid"></i>  <span> Dashboard</span> <span
                        class="menu-arrow"></span></a>
                <ul>
                    <li><a href="index.html" :active="request()->routeIs('index.html')">Admin Dashboard</a></li>
