...
<div wire:ignore.self id="elleveadd" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
 ...
 {{-- Modal pour edit des students --}}

 <div wire:ignore.self id="eleveedit" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <div class="text-center mt-2 mb-4">
                ...
                <form wire:submit.prevent='updateStudent' class="px-3">
                    ...
                    <div class="mb-2 text-center">
                        <button class="btn rounded-pill btn-primary" type="submit">Edit</button>
                    </div>
                </form>
            </div>
        </div>
